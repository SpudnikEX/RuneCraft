...
public armor() {
		...
		RIGHTFOOT.setTextureOffset(5, 58).addCuboid(-1.7F, 11.3F, -1.3F, 3.0F, 0.0F, 2.0F, 1.1F, false);
		RIGHTFOOT.setTextureOffset(5, 58).addCuboid(-1.6F, 11.6F, -2.5F, 2.0F, 0.0F, 3.0F, 1.0F, false);
