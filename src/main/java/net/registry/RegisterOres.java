...
public class RegisterOres {
    ...
    public static final Item DRAGONITE_ORE = new Item(new FabricItemSettings().group(RuneCraft.ORES));
    ...
    public static final Block IRON_ORE_BLOCK = new OreBlock(FabricBlockSettings.of(Material.STONE).strength(5,5).sounds(BlockSoundGroup.STONE).breakByTool(FabricToolTags.PICKAXES).requiresTool());
    ...
    public static final Block GOLD_ORE_BLOCK = new OreBlock(FabricBlockSettings.of(Material.STONE).strength(5,5).sounds(BlockSoundGroup.STONE).breakByTool(FabricToolTags.PICKAXES).requiresTool());
    ...
    public static final Block DRAGONITE_ORE_BLOCK = new OreBlock(FabricBlockSettings.of(Material.STONE).strength(5,5).sounds(BlockSoundGroup.STONE).breakByTool(FabricToolTags.PICKAXES).requiresTool());
    ...
    public static void register(){
        ...
        registerBlock("iron_ore",IRON_ORE,"iron_ore_block",IRON_ORE_BLOCK);
        registerBlock("silver_ore",SILVER_ORE,"silver_ore_block",SILVER_ORE_BLOCK);
        registerBlock("gold_ore",GOLD_ORE,"gold_ore_block",GOLD_ORE_BLOCK);
        ...
        registerBlock("dragonite_ore",DRAGONITE_ORE,"dragonite_ore_block",DRAGONITE_ORE_BLOCK);
    }
