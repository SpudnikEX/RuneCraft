...
public class RegisterTools {
    ...
    public static final Item DEBUG_AXE = new AxeBase(ToolMaterials.DIAMOND, 5,5, new FabricItemSettings().group(RuneCraft.TOOLS));
...
//    public static final TridentItem
    ...
    public static void register(){
        ...
        Registry.register(Registry.ITEM, new Identifier(RuneCraft.MOD_ID, "debug_axe"),DEBUG_AXE);
    }
}
