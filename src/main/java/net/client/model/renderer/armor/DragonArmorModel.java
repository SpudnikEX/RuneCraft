...
public class DragonArmorModel extends RunecraftArmorModel{
    ...
    public DragonArmorModel(EquipmentSlot slot) {
        ...
        RIGHTFOOT.setTextureOffset(6, 44).addCuboid(-1.5F, 11.5F, -3.15F, 3.0F, 0.0F, 0.0F, 0.7F, true);
        RIGHTFOOT.setTextureOffset(31, 44).addCuboid(-0.3F, 10.2F, -3.3F, 0.0F, 0.0F, 0.0F, 0.0F, false);
        ...
        LEFTFOOT.setTextureOffset(5, 44).addCuboid(-1.5F, 11.5F, -3.15F, 3.0F, 0.0F, 0.0F, 0.7F, false);
        LEFTFOOT.setTextureOffset(31, 44).addCuboid(-0.3F, 10.2F, -3.3F, 0.0F, 0.0F, 0.0F, 0.0F, false);
