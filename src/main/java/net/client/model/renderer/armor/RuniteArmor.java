...
public class RuniteArmor extends ArmorItem {
    @Environment(EnvType.CLIENT)
    private BipedEntityModel<LivingEntity> model;
    public final EquipmentSlot type;


    public RuniteArmor(ArmorMaterial mat, EquipmentSlot type, Settings props) {
    ...
    public final String getArmorTexture(ItemStack stack, EquipmentSlot slot) {
        return "runecraft:textures/item/armor/runite/runite_model.png";
