...
public class VeracsArmorModel extends RunecraftArmorModel{
    ...
    public VeracsArmorModel(EquipmentSlot slot) {
        ...
        BODY.setTextureOffset(31, 46).addCuboid(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, 0.1F, false);
        BODY.setTextureOffset(2, 53).addCuboid(-4.0F, 12.45F, -1.5F, 8.0F, -1.0F, 3.0F, 0.9F, false);
        ...
        RIGHTARM.setTextureOffset(35, 46).addCuboid(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.1F, false);
        ...
        RIGHTLEG.setTextureOffset(35, 46).addCuboid(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.1F, false);
        ...
        LEFTLEG.setTextureOffset(35, 46).addCuboid(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, 0.1F, false);
