...
//
///**
// * {@link net.minecraft.screen.FurnaceScreenHandler} {@link net.minecraft.screen.AbstractFurnaceScreenHandler}
// */
...
//        this(RegisterDebug.FORGE_SCREEN_HANDLER, RecipeType.SMELTING, RecipeBookCategory.FURNACE, syncId, playerInventory);
//    }
//
...
//        this(RegisterDebug.FORGE_SCREEN_HANDLER, RecipeType.SMELTING, RecipeBookCategory.FURNACE, syncId, playerInventory, new SimpleInventory(12), propertyDelegate);
//    }
//
...
////    }
//
//    protected ForgeScreenHandler(ScreenHandlerType<?> type, RecipeType<? extends AbstractCookingRecipe> recipeType, RecipeBookCategory recipeBookCategory, int i, PlayerInventory playerInventory) {
//        this(type, recipeType, recipeBookCategory, i, playerInventory, new SimpleInventory(3), new ArrayPropertyDelegate(4));
//    }
//
//    protected ForgeScreenHandler(ScreenHandlerType<?> type, RecipeType<? extends AbstractCookingRecipe> recipeType, RecipeBookCategory recipeBookCategory, int i, PlayerInventory playerInventory, Inventory inventory, PropertyDelegate propertyDelegate) {
//        super(type, i);
...
//        this.addSlot(new ForgeFuelSlot(this, inventory, 1, 56, 53));
