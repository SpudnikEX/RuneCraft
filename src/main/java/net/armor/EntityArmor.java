...
public class EntityArmor extends ArmorItem {

    @Environment(EnvType.CLIENT)
    private BipedEntityModel<LivingEntity> model;
    public final EquipmentSlot type;

    public EntityArmor(ArmorMaterial mat, EquipmentSlot type,  Settings props) {
    ...
    public final String getArmorTexture(ItemStack stack, EquipmentSlot slot) {
        return "runecraft:textures/models/armor/hallowed_model.png";
    }
}
